...
> The broadcast‑room console for indie live shows—run cues, risks, and comms from a single browser.

---

## Overview

Indie producers and demo‑day organizers lack a focused, real‑time cue‑management tool that feels like a broadcast control room, forcing them to improvise with generic CRMs or spreadsheets.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/stagesignal
      branch: master
...
<p align="center">
  Generated by <a href="https://github.com/Two-Weeks-Team/vibeDeploy"><strong>vibeDeploy</strong></a> | Vibe Score: **69.9**
</p>
